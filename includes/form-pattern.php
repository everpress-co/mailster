...
<form method="post" action="" novalidate class="wp-block-mailster-form-wrapper mailster-block-form mailster-form"><div class="mailster-block-form-inner"><div class="mailster-block-form-info"><div class="mailster-block-form-info-success"></div><div class="mailster-block-form-info-error"></div></div><!-- wp:mailster/field-email {"className":"mailster-wrapper-type-email"} -->
...
<form method="post" action="" novalidate class="wp-block-mailster-form-wrapper mailster-block-form mailster-form has-background"><div class="mailster-block-form-inner"><div class="mailster-block-form-info"><div class="mailster-block-form-info-success"></div><div class="mailster-block-form-info-error"></div></div><!-- wp:heading {"textAlign":"center","level":4,"align":"full"} -->
...
<form method="post" action="" novalidate class="wp-block-mailster-form-wrapper mailster-block-form mailster-form has-background"><div class="mailster-block-form-inner"><div class="mailster-block-form-info"><div class="mailster-block-form-info-success"></div><div class="mailster-block-form-info-error"></div></div><!-- wp:heading {"textAlign":"center","align":"full"} -->
