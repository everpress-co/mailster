...
<?php if ( $editable ) : ?>
	...
	<input name="mailster_data[embed_images]" id="mailster_data_embed_images" value="<?php echo (isset( $this->post_data['embed_images'] ) ? $this->post_data['embed_images'] : mailster_option( 'embed_images' )) ?>" type="hidde">
	<p>
		<label>
