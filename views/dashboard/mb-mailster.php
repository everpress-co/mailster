...
<dl class="mailster-icon mailster-icon-finished valid">
	<dt><?php esc_html_e( 'Verified License', 'mailster' ); ?>
	</dt>
	...
	<?php if ( ! mailster()->is_email_verified() ) : ?>
		<dd class="error inline" style="color:#c00"><?php esc_html_e( 'Your email address has not been verified yet!', 'mailster' ); ?></dd>
	<?php endif; ?>
	<dd>
