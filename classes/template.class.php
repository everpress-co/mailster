...
class MailsterTemplate {
	...
	public function create_new( $name, $content = '', $modules = true, $active = false, $overwrite = false ) {
		...
		if ( $name == esc_html__( 'Base', 'mailster' ) . ' - ' . esc_html_x( 'RTL', 'right-to-left languages', 'mailster' ) ) {
		...
		if ( $name == esc_html__( 'Notification', 'mailster' ) . ' - ' . esc_html_x( 'RTL', 'right-to-left languages', 'mailster' ) ) {
