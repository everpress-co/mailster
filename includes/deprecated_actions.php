...
add_action( 'mailster_campaign_pause', function( $id ){
	mailster_do_depcreated_mymail_action( 'mymail_campaign_pause', $id );
},10,1);

add_action( 'mailster_campaign_start', function( $id ){
	mailster_do_depcreated_mymail_action( 'mymail_campaign_start', $id );
},10,1);

add_action( 'mailster_finish_campaign', function( $id ){
	mailster_do_depcreated_mymail_action( 'mymail_finish_campaign', $id );
},10,1);

add_action( 'mailster_campaign_duplicate', function( $id, $new_id ){
...
add_action( 'mailster_autoresponder_timebased', function( $campaign_id, $new_id ){
	mailster_do_depcreated_mymail_action( 'mymail_autoresponder_timebased', $campaign_id, $new_id );
},10,2);

add_action( 'mailster_autoresponder_usertime', function( $campaign_id, $subscriber_ids ){
...
add_action( 'mailster_notification_error', function( $subscriber_id, $error_message ){
...
add_action( 'mailster_cron_finished', function(){
	mailster_do_depcreated_mymail_action( 'mymail_cron_finished' );
});

add_action( 'mailster_subscriber_save', function( $subscriber_id ){
