...
class MailsterQueue {
	...
	public function progress( $campaign_id = null, $process_id = 0 ) {
		...
		$to_send = $process_to_send = $this->size( $microtime, $campaign_id );
		if ( $processes ) {
			$process_to_send = $this->size( $microtime, $campaign_id, $process_id );
		}
	 ...
	 * @return unknown
	 */
	public function size( $microtime = null, $campaign_id = null, $process_id = null ) {
