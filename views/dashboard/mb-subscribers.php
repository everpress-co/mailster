...
<div class="mailster-mb-subscribers mailster-loading">
	...
	<?php if ( ! $this->is_dashboard ) : ?>
		<?php printf( esc_html__( 'You have %s', 'mailster' ), '<a class="mailster-subscribers" href="edit.php?post_type=newsletter&page=mailster_subscribers&status=1">' . number_format_i18n( $subscribers ) . ' ' . _n( 'Subscriber', 'Subscribers', $subscribers, 'mailster' ) . '</a>' ); ?>
	<?php endif; ?>
	</div>
