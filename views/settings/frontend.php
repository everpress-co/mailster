...
<div id="webversion-bar-options" 
<?php
if ( ! mailster_option( 'webversion_bar' ) ) {
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<div class="archive-slug" 
		<?php
		if ( ! mailster_option( 'hasarchive' ) ) {
			echo ' style="display:none"'; }
		?>
		>
			<p>
		...
		?>
			...
			<p><label>
			<?php
			esc_html_e( 'show only', 'mailster' );
			$archive_types = mailster_option( 'archive_types', array( 'finished', 'active' ) );
			?>
			: </label>
