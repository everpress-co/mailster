...
class MailsterDashboard {
	...
	public function scripts_styles() {
		...
		// wp_enqueue_script( 'mailster-chartjs', MAILSTER_URI . 'assets/js/libs/chart' . $suffix . '.js', array( ), MAILSTER_VERSION, true );

		wp_enqueue_script( 'mailster-dashboard-script', MAILSTER_URI . 'assets/js/dashboard-script' . $suffix . '.js', array( 'mailster-charts-script', 'mailster-script', 'postbox' ), MAILSTER_VERSION, true );
