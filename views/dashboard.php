...
<?php elseif ( ! mailster_option( 'usage_tracking' ) && mailster_option( 'ask_usage_tracking' ) && time() - get_option( 'mailster' ) > HOUR_IN_SECONDS && $this->verified && current_user_can( 'manage_options' ) ) : ?>
