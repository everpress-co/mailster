<p class="description"><?php esc_html_e( 'You can log all outgoing mails sent by Mailster. This is useful if you like to keep debug issues during sending. Disable this settings if you don\'t need logging as it uses more server resources. ', 'mailster' ); ?></p>
<table class="form-table">
	...
	<tr valign="top" class="settings-row settings-logging-max">
		...
		<td><input type="number" name="mailster_options[logging_max]" value="<?php echo esc_attr( mailster_option( 'logging_max' ) ); ?>" class="small-text"> <span class="description"><?php esc_html_e( 'Number of entries kept in the database.', 'mailster' ); ?></span></td>
	</tr>
...
<p class="description">* <?php esc_html_e( 'Cleanup is delayed so the database can contain more entries. Keep field empty to ignore setting.', 'mailster' ); ?></p>
