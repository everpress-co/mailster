...
class MailsterDashboard {
	...
	public function scripts_styles() {
		...
		wp_enqueue_script( 'mailster-dashboard-script', MAILSTER_URI . 'assets/js/dashboard-script' . $suffix . '.js', array( 'mailster-script', 'postbox', 'mailster-helpscout' ), MAILSTER_VERSION, true );
