...
<div class="wp-block-mailster-field-submit mailster-wrapper mailster-wrapper-type-submit wp-block-button"><input name="submit" type="submit" value="Subscribe" class="wp-block-button__link"/></div>
...
<div class="wp-block-mailster-field-submit mailster-wrapper mailster-wrapper-type-submit wp-block-button" style="width:40%"><input name="submit" type="submit" style="color:#39414D;background-color:#D1E4DD" value="Subscribe" class="wp-block-button__link"/></div>
<!-- /wp:mailster/field-submit -->

<!-- wp:mailster/gdpr -->
<div class="wp-block-mailster-gdpr mailster-wrapper mailster-wrapper-_gdpr"><label><input type="hidden" name="_gdpr" value="0"/><input type="checkbox" name="_gdpr" value="1"/><span>I agree to the privacy policy and terms.</span></label></div>
<!-- /wp:mailster/gdpr --></form>
<!-- /wp:mailster/form-wrapper -->',
		...
		'oneliner'   => array(
			...
			'description' => _x( 'Two horizontal buttons, the left button is filled in, and the right button is outlined.', 'Block pattern description', 'mailster' ),
			'content'     => '<!-- wp:mailster/form-wrapper {"style":{"color":{"background":"#8ed1fc"},"borderWidth":"0px"},"background":{"opacity":40,"fixed":false,"repeat":false,"size":"cover","image":"","position":{"x":0.5,"y":0.5}},"css":{"general":".mailster-form{\n\tpadding:2em;\n\tborder-radius:5px;\n}\n.mailster-wrapper-type-email{\n    background:#fff; \n    border-radius:5px 0 0 5px;\n}\n.mailster-wrapper-type-email .input{\n    height:72px;\n}\nh4{\n  margin:0 0 1em;\n}\n","tablet":"","mobile":""},"className":"has-background"} -->
...
<div class="wp-block-mailster-field-submit mailster-wrapper mailster-wrapper-type-submit wp-block-button" style="width:30%"><input name="submit" type="submit" value="Subscribe" class="wp-block-button__link"/></div>
<!-- /wp:mailster/field-submit -->
