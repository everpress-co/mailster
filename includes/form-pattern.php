...
<div class="wp-block-mailster-field-submit mailster-wrapper mailster-wrapper-asterisk wp-block-button" style="width:57%"><input name="submit" type="submit" style="background-color:#ffffff;border-color:#1A1B1F;border-width:3px" value="Get 20% now" class="wp-block-button__link submit-button"/></div>
<!-- /wp:mailster/field-submit --></div></form>
<!-- /wp:mailster/form-wrapper -->',
