		...
		<div class="theme-wrap wp-clearfix" role="document">
			...
			<div class="theme-actions">
				<div class="active-theme">
					...
					<a class="button duplicate-campaign" href="<?php echo admin_url( 'post-new.php?post_type=newsletter&template=' . $item['slug'] ); ?>" aria-label="<?php esc_attr_e( 'Duplicate Campaign', 'mailster' ); ?>"><?php esc_html_e( 'Duplicate', 'mailster' ); ?></a>
				</div>
