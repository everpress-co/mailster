...
<table class="form-table">
	...
	<tr valign="top">
		...
		<?php if ( $customfields ) : ?>
			...
			<ul class="customfield-additional customfield-dropdown customfield-radio" 
				<?php
				if ( in_array( $data['type'], array( 'dropdown', 'radio' ) ) ) {
...
>
			...
			<div class="customfield-additional customfield-checkbox" style="display:block">
				<span>&nbsp;</span> <label><input type="hidden" name="mailster_options[custom_field][<?php echo $id; ?>][default]" value=""><input type="checkbox" name="mailster_options[custom_field][<?php echo $id; ?>][default]" value="1" title="<?php esc_html_e( 'this field is selected by default', 'mailster' ); ?>" 
																												<?php
																												if ( isset( $data['default'] ) ) {
