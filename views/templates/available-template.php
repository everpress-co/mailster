...
?>
	...
	?>
		...
		if ( isset( $data['description'] ) ) :
			?>
			<p><?php echo $data['description']; ?></p><?php endif; ?>
		</div>
		<?php if ( ! $unsupported ) : ?>
			...
			<ul>
				...
				<?php elseif ( isset( $data['uri'] ) ) : ?>
					...
					<?php if ( isset( $data['envato_item_id'] ) ) : ?>
						...
						<li>
							<a title="<?php esc_html_e( 'download via Envato', 'mailster' ); ?>" class="envato-activate button" href="
														<?php
														echo add_query_arg(
															array(
														...
														?>
																																		" data-slug="<?php echo $slug; ?>"><?php esc_html_e( 'Download', 'mailster' ); ?></a>
						</li>
					...
					<li class="alignright">
						<a title="<?php esc_html_e( 'activate on Envato', 'mailster' ); ?>" class="envato-activate update button button-primary" href="
													<?php
													echo add_query_arg(
														array(
															'auth' => wp_create_nonce( 'envato-activate' ),
