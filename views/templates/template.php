...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>" tabindex="0" data-slug="<?php echo esc_attr( $item['slug'] ); ?>" data-item='<?php echo esc_attr( json_encode( $item ) ); ?>'>
	...
	<div class="theme-screenshot">
		...
		<?php if ( $item['index'] ) : ?>
		<iframe src="<?php echo esc_url( $item['index'] ); ?>" class="theme-screenshot-iframe" scrolling="no" allowTransparency="true" frameBorder="0" sandbox="allow-presentation allow-scripts" loading="lazy"></iframe>
		<?php else : ?>
