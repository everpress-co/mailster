<table class="form-table">
	...
	<tr valign="top" class="settings-row settings-row-auto-click-prevention">
		<th scope="row"><?php esc_html_e( 'Auto Click Prevention', 'mailster' ); ?> <a class="mailster-infolink external" href="<?php echo mailster_url( 'https://kb.mailster.co/prevent-spam-filters-automatically-opening-and-clicking-through-links-in-your-campaigns/' ); ?>" title="<?php esc_attr_e( 'More info on our knowledge base.', 'mailster' ); ?>" data-article="611badd2b37d837a3d0e4729"></a></th>
		<td>
