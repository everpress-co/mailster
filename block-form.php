...
do_action( 'mailster_block_form_header' );
...
<head>
	...
	<?php do_action( 'mailster_block_form_head' ); ?>

</head>
<body>
	<div class="mailster-block-form-body">
		<?php do_action( 'mailster_block_form_body' ); ?>
	</div>
<?php do_action( 'mailster_block_form_footer' ); ?>
</body>
</html>
