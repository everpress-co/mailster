...
class MailsterLists {
	...
	public function view_lists() {
		...
		if ( isset( $_GET['ID'] ) || isset( $_GET['new'] ) ) :
			...
			wp_enqueue_script( 'mailster-list-detail', MAILSTER_URI . 'assets/js/list-script' . $suffix . '.js', array( 'mailster-charts-script', 'mailster-script' ), MAILSTER_VERSION, true );
